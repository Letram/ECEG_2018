    ...
    <asp:UpdatePanel ID="update_year_dropdown_panel" runat="server">
        <ContentTemplate>
            <div class="p-2 form-inline">
                ...
                <%--                <asp:ListBox ID="dropdown_year" runat="server" CssClass="form-control multi"
                    SelectionMode="Multiple" Rows="1"
                    AutoPostBack="true"
                    AppendDataBoundItems="true"
                    OnSelectedIndexChanged="dropdown_year_SelectedIndexChanged">
                    <asp:ListItem Text="All years" Value="All" Selected="True"></asp:ListItem>
                </asp:ListBox>--%>
                <asp:DropDownList ID="dropdown_editions" runat="server" CssClass="form-control m-lateral"
